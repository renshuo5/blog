...
<HTML><HEAD><TITLE>Sorry! 你访问的页没找到！</TITLE>
<META http-equiv=Content-Type content="text/html; charset=UFT-8">
<META http-equiv=refresh content="5;URL =<%=path %>/manage">
        ...
        <TR>
          ...
          <TD>
            ...
            border=0>
              <TBODY>
              <TR>
                <TD height=22>5555~~~，不知道怎么回事页面出错了,稍后重试哦。</TD></TR>
              <TR>
                <TD height=22>
                  <LI>赶快访问<A href="<%=path %>/manage"><font color="#990000">主页</font></A></LI></TD></TR>
              <TR>
                <TD style="PADDING-RIGHT: 8px">
                  <LI>我们定于5秒钟之后自动引爆炸弹，你不跑还呆着啊！</LI></TD></TR></TBODY></TABLE><BR></DIV></TD></TR></TBODY></TABLE>
      <P>　</P></TD></TR>
  <TR>
    <TD vAlign=bottom align=right><A href="<%=path %>/manage"><FONT 
